					...
					<div class="formReservas py-1 py-lg-2 px-4">
						...
						<div class="form-group my-4">
							<select class="form-control form-control-lg selectTemaHabitacion" name="id-habitacion" required>
								...
								<option value="">Tamaño del tatto</option>
...
<nav class="menu container-fluid p-0">
	...
	<ul class="nav nav-justified py-2">
		...
		<li class="nav-item">
			<a class="nav-link text-white" href="#planes">Paquetes</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#habitaciones">Tattos</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#pueblo">El studio</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white" href="#restaurante">Galeria</a>
		</li>
...
<div class="menuMovil">
	...
	<ul class="nav flex-column mt-4 pl-4 mb-5">
		...
		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#planesMovil">Paquetes</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#habitaciones">Tattos</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#pueblo">Recorrido por el studio</a>
		</li>

		<li class="nav-item">
			<a class="nav-link text-white my-2" href="#restaurante">Galeria</a>
		</li>
