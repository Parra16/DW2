    ...
    success:function(respuesta){
       ...
       if(!respuesta){
        ...
        $(".elegirPlan").change(function(){
          ...
          $(".precioReserva span").html($(".elegirPlan").val().split(",")[0]*dias * $(".elegirPlan").val().split(",")[2]);
          $(".precioReserva span").number(true);
          $(".pagarReserva").attr("pagoReserva",($(".elegirPlan").val().split(",")[0]*dias) * ($(".elegirPlan").val().split(",")[2]) );
          $(".pagarReserva").attr("plan",$(".elegirPlan").val().split(",")[1]);
          $(".pagarReserva").attr("personas",$(".elegirPlan").val().split(",")[2]);
...
function cambioPlanesPersonas(){
  $(".precioReserva span").html(($(".elegirPlan").val().split(",")[0]*dias) * ($(".elegirPlan").val().split(",")[2]));
  $(".precioReserva span").number(true);
  $(".pagarReserva").attr("pagoReserva",Number($(".elegirPlan").val().split(",")[0]*dias) * Number($(".elegirPlan").val().split(",")[2]) );
      $(".pagarReserva").attr("plan",$(".elegirPlan").val().split(",")[1]);
      $(".pagarReserva").attr("personas",$(".elegirPlan").val().split(",")[2]);
  /*
...
$(".pagarReserva").click(function(){
  ...
  crearCookie("fechaSalida", fechaIngreso, 1);
