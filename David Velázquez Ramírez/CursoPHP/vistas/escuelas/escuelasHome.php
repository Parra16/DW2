    ...
    <div class="contenedor active" id="contenedor">
        ...
        <main class="main">
            ...
            if ($_SESSION['Nav'] == 1) {
                ...
                include_once '/xampp/htdocs/CursoPHP/includes/escuelas/newEscuela.php';
            } else if ($_SESSION['Nav'] == 3) {
                include_once '/xampp/htdocs/CursoPHP/includes/escuelas/dropEscuela.php';
            } else if ($_SESSION['Nav'] == 4) {
                include_once '/xampp/htdocs/CursoPHP/includes/escuelas/modifyEscuela.php';
            }
